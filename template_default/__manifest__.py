...

{
    ...
    'author': "jeo Software",
    'website': 'https://github.com/sebacorreacalamuchita/cl-template2/tree/imagen-doodba',
    'license': 'AGPL-3',
    'depends': [
        'standard_depends_ce'
        ],
    ...
    'port': '8120',
    'longpolling_port': '8125',

    'git-repos': [
        'https://github.com/sebacorreacalamuchita/cl-template2/tree/imagen-doodba',
